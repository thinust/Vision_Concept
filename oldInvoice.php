        ...
        <main class="my-5 offset-lg-0 col-lg-9 col-md-12 col-10 col-sm-12 offset-md-0">
            <div class="container">
                ...
                <div class="col-12  col-lg-8   p-3 mb-3">
                    <span class="col-12 addprohead fs-lg-1 fs-1">Old Invoice</span>
                ...
                <div class="col-lg-10 col-12 offset-1">
                    <div class="row">
                        ...
                        <div class="col-12 mb-3 mt-3">
                            <div class="row">
                                <div class="col-lg-10 col-12">
                                    <input type="date" class="form-control mx-lg-3" placeholder="Enter Date" id="date" value="">
                                </div>
                                <label class="form-label fw-bold lbl1 mx-4 col-10">
                                    Date
                                </label>
                        ...
                        <div class=" col-12 d-grid mx-3 mb-5 mt-5">
                            <button class="btn fw-bold fs-4 text-light" onclick="addOldInvoice(<?php echo $id; ?>,<?php echo $iuid; ?>);" style="background:  #7f0eb4;">Add Invoice</button>
                        </div>
